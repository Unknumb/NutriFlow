...
const FoodItemRow = ({ food }: { food: FoodItem }) => (
    <div className="flex items-center justify-between p-3 bg-white border border-gray-100 rounded-lg hover:border-teal-200 transition-colors group">
        <div className="flex items-center gap-4">
            ...
            <div>
                ...
                <p className="text-xs text-gray-500">{food.quantity} {food.unit}</p>
            </div>
        </div>
        <div className="flex items-center gap-6">
            <div className="text-right">
                <p className="font-bold text-gray-900">{food.kcal} kcal</p>
                <div className="flex gap-2 text-[11px] font-medium mt-0.5">
                    <span className="text-red-600">P:{food.macros.prot}g</span>
                    <span className="text-blue-600">C:{food.macros.cho}g</span>
                    <span className="text-amber-600">G:{food.macros.fat}g</span>
                </div>
            </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden mb-5">
            ...
            <div className="px-5 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/30">
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-medium text-gray-500 bg-gray-100 px-2 py-0.5 rounded-md">{meal.time}</span>
                </div>
            ...
            <div className="p-5 space-y-3">
                ...
                {/* Botón Añadir */}
                <button className="w-full py-3 border-2 border-dashed border-gray-200 rounded-lg text-gray-500 font-medium text-sm hover:border-teal-400 hover:text-teal-600 hover:bg-teal-50/50 transition-all flex items-center justify-center gap-2 mt-2">
