...
export const FOOD_GROUPS: FoodGroupDef[] = [
    ...
    { id: 'veg', title: "Verduras en General", kcal: 30, macros: { p: 2, c: 5, g: 0 }, theme: { bgMain: 'bg-white', bgHeader: 'bg-[#4F7A5A]', border: 'border-[#4F7A5A]/40', text: '' } },
    { id: 'vlb', title: "Verduras Libre Consumo", isFree: true, kcal: 15, macros: { p: 0, c: 2.5, g: 0 }, theme: { bgMain: 'bg-white', bgHeader: '', border: 'border-[#2E5547]/40', text: 'text-[#2E5547]' } },
