...
const styles = StyleSheet.create({
  ...
  summaryGrid: { flexDirection: "row", gap: 4, flexWrap: "wrap" },
  summaryBadge: {
    width: "15%",
    marginBottom: 4,
...
const ALL_GROUPS = [
  { id: "cer", label: "Cereales", emoji: "🌾", pdfBg: "#fef3c7", pdfText: "#78350f", options: "Arroz / Fideos / Pasta / Papa cocida" },
  { id: "fru", label: "Frutas", emoji: "🍎", pdfBg: "#ffedd5", pdfText: "#7c2d12", options: "Fruta a gusto / Plátano / Uvas" },
  { id: "veg", label: "Verduras", emoji: "🥦", pdfBg: "#dcfce7", pdfText: "#14532d", options: "Zanahoria / Brócoli / Coliflor" },
  { id: "vlb", label: "Verd. Libre", emoji: "🥗", pdfBg: "#d1fae5", pdfText: "#064e3b", options: "Lechuga / Apio / Pepino" },
  { id: "cag", label: "Carnes Altas", emoji: "🥓", pdfBg: "#fee2e2", pdfText: "#7f1d1d", options: "Cerdo / Cordero / Embutidos" },
  { id: "cbg", label: "Carnes Bajas", emoji: "🍗", pdfBg: "#fee2e2", pdfText: "#7f1d1d", options: "Pollo / Pavo / Pescado blanco" },
  { id: "leg", label: "Leguminosas", emoji: "🫘", pdfBg: "#fef08a", pdfText: "#713f12", options: "Lentejas / Porotos / Garbanzos" },
  { id: "lag", label: "Lác. Altos", emoji: "🧀", pdfBg: "#f3e8ff", pdfText: "#581c87", options: "Queso amarillo / Queso crema" },
  { id: "lmg", label: "Lác. Medios", emoji: "🥛", pdfBg: "#ccfbf1", pdfText: "#134e4a", options: "Leche semi / Yogurt normal" },
  { id: "lbg", label: "Lác. Bajos", emoji: "🥛", pdfBg: "#e0f2fe", pdfText: "#0c4a6e", options: "Leche descremada / Quesillo" },
  { id: "ace", label: "Aceites", emoji: "🫒", pdfBg: "#fef08a", pdfText: "#713f12", options: "Aceite de oliva / Mayonesa" },
  { id: "arg", label: "ARG", emoji: "🥑", pdfBg: "#ecfccb", pdfText: "#3f6212", options: "Palta / Almendras / Nueces" },
  { id: "azu", label: "Azúcar", emoji: "🍯", pdfBg: "#fce7f3", pdfText: "#831843", options: "Azúcar / Miel / Manjar" }
];
...
export const PautaDocumentPDF = ({ data }: any) => {
  ...
  const visibleGroups = ALL_GROUPS.filter(g => targets[g.id] > 0 || totals[g.id] > 0);
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.table}>
          <View style={styles.tableHeader}>
            ...
            <Text
              style={[styles.headerText, { width: "45%", borderRightWidth: 0 }]}
            >
              Opciones
            </Text>
          </View>
          ...
          {visibleGroups.map((g) => {
            ...
            return (
              <View
                ...
                style={[
                  styles.summaryBadge,
                  { borderColor: isExact ? "#a7f3d0" : "#fde68a" },
                ]}
              >
                <Text
                  style={{
                ...
                <Text
                  style={{
                    fontSize: 10,
                    fontWeight: "bold",
                    color: isExact ? "#047857" : "#b45309",
                    marginTop: 3,
                  }}
                >
                  {totals[g.id] || 0}/{targets[g.id] || 0}
                </Text>
              </View>
            );
          })}
