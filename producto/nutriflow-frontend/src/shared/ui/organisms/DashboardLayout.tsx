    ...
    return (
        <div className="flex h-screen bg-porcelain overflow-hidden font-sans">
            ...
            <div className="flex-1 flex flex-col overflow-hidden min-w-0">
                ...
                <div className="bg-white border-b border-mist pl-14 pr-3 md:px-6 py-2 text-sm flex items-center gap-3 z-10 min-w-0">
                    {activePatient ? (
                        <div className="flex flex-wrap items-center gap-x-3 gap-y-1 min-w-0">
                            <span className="text-[11px] uppercase tracking-[0.12em] text-pine-soft font-medium shrink-0">Paciente activo</span>
                            <span className="font-semibold text-ink truncate max-w-50 sm:max-w-none">{activePatient.nombre}</span>
                ...
                <main className="flex-1 w-full max-w-full overflow-y-auto overflow-x-hidden min-h-0 pt-2 md:pt-0 page-enter">
                    <Outlet />
                </main>
            </div>
        </div>
